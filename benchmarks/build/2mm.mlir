module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<i8, dense<[8, 32]> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i16, dense<[16, 32]> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<i128, dense<128> : vector<2xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>, llvm.data_layout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128", llvm.target_triple = "aarch64-unknown-linux-gnu", "polygeist.target-cpu" = "generic", "polygeist.target-features" = "+fp-armv8,+neon,+outline-atomics,+v8a,-fmv"} {
  func.func @main() -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %cast_8 = memref.cast %alloca_3 : memref<32x32xf32> to memref<?x32xf32>
    %cast_9 = memref.cast %alloca : memref<32x32xf32> to memref<?x32xf32>
    ...
    call @kernel_2mm(%c32_i32, %c32_i32, %c32_i32, %c32_i32, %cst_0, %cst_1, %cast_10, %cast, %cast_7, %cast_8, %cast_9) : (i32, i32, i32, i32, f32, f32, memref<?x32xf32>, memref<?x32xf32>, memref<?x32xf32>, memref<?x32xf32>, memref<?x32xf32>) -> ()
  ...
  func.func private @kernel_2mm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: f32, %arg5: f32, %arg6: memref<?x32xf32>, %arg7: memref<?x32xf32>, %arg8: memref<?x32xf32>, %arg9: memref<?x32xf32>, %arg10: memref<?x32xf32>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    ...
    omp.parallel   {
      ...
      omp.wsloop   for  (%arg11) : index = (%c0) to (%3) step (%c1) {
        affine.for %arg12 = 0 to %2 {
          memref.store %cst, %arg6[%arg11, %arg12] : memref<?x32xf32>
          affine.for %arg13 = 0 to %0 {
            %4 = memref.load %arg7[%arg11, %arg13] : memref<?x32xf32>
            %5 = arith.mulf %arg4, %4 : f32
            %6 = affine.load %arg8[%arg13, %arg12] : memref<?x32xf32>
            %7 = arith.mulf %5, %6 : f32
            %8 = memref.load %arg6[%arg11, %arg12] : memref<?x32xf32>
            %9 = arith.addf %8, %7 : f32
            memref.store %9, %arg6[%arg11, %arg12] : memref<?x32xf32>
          }
        }
        omp.yield
      }
    ...
    omp.parallel   {
      ...
      omp.wsloop   for  (%arg11) : index = (%c0) to (%3) step (%c1) {
        affine.for %arg12 = 0 to %1 {
          %4 = memref.load %arg10[%arg11, %arg12] : memref<?x32xf32>
          %5 = arith.mulf %4, %arg5 : f32
          memref.store %5, %arg10[%arg11, %arg12] : memref<?x32xf32>
          affine.for %arg13 = 0 to %2 {
            %6 = memref.load %arg6[%arg11, %arg13] : memref<?x32xf32>
            %7 = affine.load %arg9[%arg13, %arg12] : memref<?x32xf32>
            %8 = arith.mulf %6, %7 : f32
            %9 = memref.load %arg10[%arg11, %arg12] : memref<?x32xf32>
            %10 = arith.addf %9, %8 : f32
            memref.store %10, %arg10[%arg11, %arg12] : memref<?x32xf32>
          }
        }
        omp.yield
      }
